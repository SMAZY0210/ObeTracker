const AdminView={
  ...
  async _enrolBatch(){
    ...
    // batch. With a batch and no section, all sections of that batch are
    // enrolled, which is what All Sections was always meant to mean.
  ...
  async _loadPOs(){
    ...
    try{
      ...
      // table read PO1, PO10, PO11, PO12, PO2.
  ...
  async _loadStudentReport(){
    ...
    try{
      ...
      if(!stu){ el.innerHTML='<div class="alert alert-warn"><span class="alert-icon">!</span>No student matching "'+q+'".</div>'; return; }
      el.innerHTML='';
